      ...
      >
        ...
        <div className="mt-5 xl:mt-0">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Categories</h2>
          </div>
        ...
        <div className="mt-5">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Brand</h2>
          </div>
          <FormGroup className="mt-4 ml-1">
        ...
        <div className="mt-5">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Ratings</h2>
          </div>
          <FormGroup className="mt-4 ml-1">
        ...
        <div className="mt-5">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Features</h2>
          </div>
          <FormGroup className="mt-4 ml-1">
        ...
        <div className="mt-5">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Discount</h2>
          </div>
          <FormGroup className="mt-4 ml-1">
        ...
        <div className="mt-5">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Color</h2>
          </div>
        ...
        <div className="mt-5 pb-10">
          <div className="border-b-[2px]">
            <h2 className="font-medium text-[20px]">Price</h2>
          </div>
          <Box sx={{ marginTop: 1 }}>
            <Stack
              spacing={2}
          ...
          <div className="flex justify-between -mt-4">
            <span className="numText text-[18px] font-medium">₹ 0</span>
            <span className="numText text-[18px] font-medium">₹ 9999</span>
          </div>
        </div>
      </aside>
    </>
